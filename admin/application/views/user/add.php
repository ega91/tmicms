...
<p>&nbsp;</p>
<h3>Orang Terdekat</h3>
<h4 style="margin-bottom: 20px;">User baru harus mengisi data orang terdekat</h4>
<div class="form-group">
  <label class="control-label">Nama Lengkap</label>
  <input type="text" class="form-control" name="family_name" placeholder="Nama lengkap" value="<?=(!empty($data->family_name))?$data->family_name:''?>">
</div>

<div class="form-group">
  <label class="control-label">Email</label>
  <input type="text" class="form-control" name="family_email" placeholder="Email" value="<?=(!empty($data->family_email))?$data->family_email:''?>">
</div>

<div class="form-group">
  <label class="control-label">No. Telp.</label>
  <input type="text" class="form-control" name="family_phone" placeholder="No. telp." value="<?=(!empty($data->family_phone))?$data->family_phone:''?>">
</div>

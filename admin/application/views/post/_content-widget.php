	<li class="new-content-content">
		...
		<input type="hidden" name="sections[<?php echo $section_idx?>][contents][<?php echo $content_idx?>][content_type]" value="widget">
		...
		<div class="new-content-title"><i class="fa fa-file-code-o fa-fw"></i>  Widget</div>

		<div class="new-content-content-inside">
			<div class="form-group">
				<textarea rows="4" name="sections[<?php echo $section_idx?>][contents][<?php echo $content_idx?>][embed_code]" class="form-control" placeholder="Widget Embed Code"><?php echo (!empty($content->data->embed_code))?$content->data->embed_code:''?></textarea>
				<p class="help-block">Embed code dari widget yang akan ditampilkan.</p>
		    </div>
